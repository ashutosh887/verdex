...
- Model calls (sample run): **98** (0 billed, 98 cached).
- Tokens: **0** in / **0** out.
- Images processed: **29**.
- Sample-set est. cost: **$0.0** (≈ $0.0000/claim).
- Extrapolated full test set (44 rows): **≈ $0.0** (pricing assumptions in `config.yaml`; verify vs current OpenAI pricing).
- Wall-clock: **1.1s** for 20 claims (serial).
